...
# needs dlply due to list. Might be worth making a dataframe containing
# lists, but lists are good for now
...
# outputs number alive at t1, number of those alive at t1 that made it
# to t2, and number alive at t2
...
# again, it can be a dataframe as it always returns 4 values. last is a
# pertubation one, can just run normal sim
